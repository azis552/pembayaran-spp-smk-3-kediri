    ...
    var _componentTypeahead = function() {
        ...
        var countries = new Bloodhound({
            ...
            prefetch: {
                ...
                url: '<?= base_url(assets/global_assets/demo_data/typeahead/countries.json',
        ...
        var bestPictures = new Bloodhound({
            datumTokenizer: Bloodhound.tokenizers.obj.whitespace('value'),
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: '<?= base_url(assets/global_assets/demo_data/typeahead/movies.json',
            remote: '<?= base_url(assets/global_assets/json/queries/%QUERY.json'
        });
        ...
        var nbaTeams = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: '<?= base_url(assets/global_assets/demo_data/typeahead/nba.json'
        });
        ...
        var nhlTeams = new Bloodhound({
            datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: '<?= base_url(assets/global_assets/demo_data/typeahead/nhl.json'
        });
