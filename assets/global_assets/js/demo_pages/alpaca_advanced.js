...
var AlpacaAdvanced = function() {
    ...
    var _componentAlpacaAdvanced = function() {
        ...
        $('#alpaca-option-tree-connector').alpaca({
            schemaSource: '<?= base_url(assets/global_assets/demo_data/alpaca/optiontree-custom-schema.json',
            optionsSource: '<?= base_url(assets/global_assets/demo_data/alpaca/optiontree-custom-options.json',
            options: {
                focus: false
            }
        });
