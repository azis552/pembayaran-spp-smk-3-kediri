...
var Plupload = function() {
    ...
    var _componentPlupload = function() {
        ...
        $('.file-uploader').pluploadQueue({
            ...
            url: '<?= base_url(assets/global_assets/demo_data/uploader/plupload.json',
            chunk_size: '300Kb',
            unique_names: true,
            header: true,
            filters: {
        ...
        $('.flash-uploader').pluploadQueue({
            ...
            flash_swf_url: '<?= base_url(assets/global_assets/js/plugins/uploaders/plupload/files/Moxie.swf'
        });
