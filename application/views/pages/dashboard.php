											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/facebook.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/youtube.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/spotify.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/twitter.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/bing.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/amazon.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/brands/dribbble.svg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="<?= base_url('assets/global_assets/images/placeholders/placeholder.jpg')?>" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
										...
										<ul class="media-list">
											<li class="media">
												<div class="mr-3 position-relative">
													<img src="<?= base_url('assets/global_assets/images/placeholders/placeholder.jpg')?>" class="rounded-circle" width="36" height="36" alt="">
